...
# Self-sleep DISABLED — Pod runs 24/7 (CTO decision 2026-03-29)
# Re-enable by setting VISION_IDLE_TIMEOUT, RUNPOD_POD_ID, RUNPOD_API_KEY on Pod

def _touch():
    """No-op — self-sleep disabled."""
    pass
